...
// This minimal Azure Sphere app repeatedly toggles GPIO 8, which is the red
// channel of RGB
// LED 1 on the MT3620 RDB. Use this app to test that device and SDK
// installation succeeded
// that you can build, deploy, and debug a CMake app with Visual Studio.
//
// It uses the API for the following Azure Sphere application libraries:
// - log (messages shown in Visual Studio's Device Output window during
// debugging)
